...
const Dashboard = () => {
  ...
  return (
    ...
    <div className='flex gap-4 my-8'>
        ...
        <div className='flex flex-col sm:ml-4 fontt-medium'>
        ...
        <table className='w-full'>
            ...
            {dashboardData.bookings.map((item, index)=>(
              <tr key={index}>
                ...
                <td className='py-3 px-4 border-t border-gray-300 flex'><button className={`py-1 px-3 rounded-full text-xs mx-auto ${item.isPaid ? "bg-green-200 text-green-600":"bg-amber-200 text-yellow-600"}`}>
