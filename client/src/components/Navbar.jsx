...
const Navbar = () => {
  ...
  const { user, navigate, isOwner, setShowHotelReg, isLoading } = useAppContext();
  ...
  const handleHotelButtonClick = () => {
    ...
    if (isOwner === true) {
      ...
      console.log("showHotelReg set to true"); // Debugging
    }
  };
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8">
        ...
        {user && (
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? "Loading..." : isOwner ? "Dashboard" : "List Your Hotel"}
          </button>
        )}
      </div>
